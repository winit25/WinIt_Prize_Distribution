...
<body>
    <div class="container">
        <div class="header">
            <img src="{{ config('app.url') }}/images/winit-logo-C73aMBts%20(2).svg" alt="WinIt Logo" width="200" style="display:block; margin:0 auto 20px auto; max-width: 100%; height: auto;">
