                    ...
                    <tr>
                        <td class="content" style="padding:32px 40px;">
                            ...
                            <div style="margin:30px 0; text-align:center;">
                                <a href="{{ url('/bulk-token/show/' . $batch_id) }}" style="display:inline-block; background-color:#0a1628; background: linear-gradient(135deg, #0a1628 0%, #122168 100%); color:#ffffff !important; text-decoration:none; padding:14px 32px; border-radius:8px; font-weight:600; font-size:16px; border:2px solid #0a1628; box-shadow:0 2px 4px rgba(10,22,40,0.2); text-align:center; line-height:1.5;"><span style="color:#ffffff !important;">View Batch Details</span></a>
                            </div>
                            @endif
