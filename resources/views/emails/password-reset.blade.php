    ...
    <div class="email-container">
        ...
        <div class="content">
            ...
            <div style="text-align: center; margin: 20px 0;">
                <a href="{{ $resetUrl }}" class="button" style="display:inline-block; padding:14px 32px; background-color:#0a1628; background: linear-gradient(135deg, #0a1628 0%, #122168 100%); color:#ffffff !important; text-decoration:none; border-radius:8px; font-weight:600; font-size:16px; margin:16px 0; text-align:center; border:2px solid #0a1628; box-shadow:0 2px 4px rgba(10,22,40,0.2);"><span style="color:#ffffff !important;">Reset Password</span></a>
            </div>
