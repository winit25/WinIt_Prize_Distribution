...
@section('title', 'Bulk Airtime Dashboard')
    ...
    <div class="d-flex align-items-start">
        ...
        <div class="ms-3 flex-grow-1">
            <h5 class="alert-heading mb-2" style="color: #059669; font-weight: 700;">
                <i class="fas fa-mobile-alt me-2"></i>BuyPower VTU Airtime Integration
            </h5>
            <p class="mb-2" style="color: #065f46;">
                The system uses the optimized <strong>/vend</strong> endpoint for VTU (Virtual Top-Up) airtime distribution. Process multiple airtime top-ups efficiently in batches.
            </p>
            <div class="row mt-3">
                <div class="col-md-6">
                    ...
                    <div class="d-flex align-items-center mb-2">
                        <i class="fas fa-check-circle me-2" style="color: #10b981;"></i>
                        <span><strong>Amount Range:</strong> ₦50 - ₦10,000 per top-up</span>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="d-flex align-items-center mb-2">
                        <i class="fas fa-check-circle me-2" style="color: #10b981;"></i>
                        <span><strong>Format:</strong> Simple CSV (name, phone_number, amount)</span>
                    </div>
                    <div class="d-flex align-items-center mb-2">
        ...
        <div class="card-body">
            ...
            <div class="alert alert-info mb-4">
                    ...
                    <ul class="mb-2">
                        ...
                        <li><strong>amount</strong> - Airtime amount in Naira (₦50 - ₦10,000, e.g., 500.00)</li>
                    ...
                    <div class="alert alert-success mt-3" style="background: linear-gradient(135deg, rgba(16, 185, 129, 0.1) 0%, rgba(16, 185, 129, 0.05) 100%); border: 1px solid #10b981;">
                        <h6><i class="fas fa-check-circle me-2" style="color: #10b981;"></i>Airtime Top-Up Information:</h6>
                        <div class="row">
                            <div class="col-md-6">
                                <ul class="mb-0">
                                    <li><strong>Phone Number:</strong> Must be 11 digits ✅</li>
                                    <li><strong>Format:</strong> 080, 081, 070, 090, 091 ✅</li>
                                    <li><strong>Amount Range:</strong> ₦50 - ₦10,000 ✅</li>
                                </ul>
                            </div>
                            <div class="col-md-6">
                                <ul class="mb-0">
                        ...
                        <small class="text-muted d-block mt-2">
                            <i class="fas fa-lightbulb me-1"></i>The CSV format is simple - just name, phone number, and amount. Each recipient will receive airtime directly to their phone number.
                        </small>
                    </div>
                    <div class="alert alert-warning mt-3">
                        ...
                        <ul class="mb-0">
                            ...
                            <li><strong>Amount:</strong> Minimum ₦50, maximum ₦10,000 per top-up</li>
                            <li><strong>Unique Numbers:</strong> Each phone number must be unique in the batch</li>
                            <li><strong>Processing:</strong> Airtime is delivered instantly to the phone number</li>
                        </ul>
                    </div>
                    <div class="mt-3">
                        <a href="{{ route('bulk-airtime.download-sample') }}" 
                           class="btn btn-outline-primary btn-sm" 
                           download="sample_recipients.csv"
                           data-bs-toggle="tooltip" 
                           data-bs-placement="top" 
                           title="Download sample CSV for airtime top-up. Format: name, phone_number, amount">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center p-3" style="background: linear-gradient(135deg, rgba(59, 130, 246, 0.05) 0%, rgba(59, 130, 246, 0.02) 100%); border-radius: 0.75rem; border: 2px solid rgba(59, 130, 246, 0.2);">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <small class="text-muted">Send airtime notification via SMS</small>
                                                </div>
                                            </div>
                                        ...
                                        <div class="d-flex justify-content-between align-items-center p-3" style="background: linear-gradient(135deg, rgba(16, 185, 129, 0.05) 0%, rgba(16, 185, 129, 0.02) 100%); border-radius: 0.75rem; border: 2px solid rgba(16, 185, 129, 0.2);">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <small class="text-muted">Send airtime notification via Email</small>
                                                </div>
                                            </div>
                                            <div class="form-check form-switch">
                        ...
                        <div class="card mb-3" id="smsTemplateCard" style="border: 1px solid rgba(18, 18, 104, 0.1); border-radius: 1rem; transition: all 0.3s ease; display: block;">
                            ...
                            <div class="card-body">
                                ...
                                <textarea 
                                    ...
                                    class="form-control" 
                                    rows="5" 
                                    placeholder="Your airtime top-up from WinIt is complete!
Amount: ₦{amount}
Phone: {phone_number}
Date: {date} {time}
Thank you for using WinIt!">
Your airtime top-up from WinIt is complete!
Amount: ₦{amount}
Phone: {phone_number}
Date: {date} {time}
...
Thank you for using WinIt!</textarea>
            ...
            <!-- Processing Status -->
                <div id="processingStatus" class="mt-4 d-none">
                    ...
                    <div class="card-body">
                        <h6><i class="fas fa-cog fa-spin"></i> Processing Airtime Batch...</h6>
                        <small class="text-muted d-block mt-1">
                            <i class="fas fa-info-circle"></i> Processing airtime top-ups in batches (each batch completes before next starts)
                        </small>
                            <div class="row">
                                <div class="col-md-6">
...
<script>
        ...
        if (passwordForm) {
            passwordForm.addEventListener('submit', async function(e) {
                ...
                try {
                    ...
                    const verifyUrl = '{{ route("bulk-airtime.verify-password") }}';
    ...
    function handleUpload(e) {
        ...
        console.log('Upload URL:', '{{ route("bulk-airtime.upload") }}');
        
        fetch('{{ route("bulk-airtime.upload") }}', {
            method: 'POST',
            body: formData,
            headers: {
                'X-CSRF-TOKEN': csrfToken,
        ...
        .then(({ data, response }) => {
            ...
            if (data.success) {
                ...
                successMessage += `<br>Click "Start Airtime Distribution" to proceed.`;
        ...
        .catch(error => {
            ...
            errorMessage += '<br><small>💡 Make sure your CSV file has the required columns: name, phone_number, amount</small>';
    ...
    function startProcessing(batchId = null) {
        ...
        console.log('Process URL:', `/bulk-airtime/process/${batch}`);
        
        fetch(`/bulk-airtime/process/${batch}`, {
            method: 'POST',
            headers: {
                'X-CSRF-TOKEN': csrfToken,
                'X-Requested-With': 'XMLHttpRequest',
        ...
        .then(data => {
            ...
            if (data.success) {
                ...
                // Show detailed success message
                let successMessage = `🚀 <strong>Airtime Distribution Started!</strong><br>`;
    ...
    function pollProcessingStatus() {
        ...
        const poll = () => {
            fetch(`/bulk-airtime/status/${batchId}`, {
                headers: {
                    'X-Requested-With': 'XMLHttpRequest',
                    'Accept': 'application/json'
                }
    ...
    function showCompletionMessage(data) {
        ...
        if (data.status === 'completed') {
            ...
            message += `<strong>${data.successful_transactions}/${data.total_recipients}</strong> airtime top-ups sent successfully (${successRate}% success rate)<br>`;
            ...
            message += `${data.successful_transactions || 0}/${data.total_recipients} airtime top-ups processed`;
            ...
            <div class="alert alert-info batch-processing-options">
                ...
                <div class="d-flex gap-2">
                    <button type="button" class="btn btn-success btn-sm" onclick="startProcessing(${batchId})">
                        <i class="fas fa-play"></i> Start Airtime Distribution
                    </button>
