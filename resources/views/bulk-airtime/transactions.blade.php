...
@section('title', 'Airtime Transaction History - WinIt Prize Distribution')
    ...
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <p class="text-muted mb-0">View and download all airtime top-up transactions</p>
            </div>
            <div>
                <a href="{{ route('bulk-airtime.history') }}" class="btn btn-outline-secondary me-2">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form id="searchFilterForm" method="GET" action="{{ route('bulk-airtime.transactions') }}" class="search-filter-form">
                    <div class="row g-3 align-items-end">
                        ...
                        <div class="col-md-2 d-flex gap-2">
                            ...
                            <a href="{{ route('bulk-airtime.transactions') }}" class="btn btn-outline-secondary btn-sm">
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                ...
                                                @if($transaction->batchUpload)
                                                    <a href="{{ route('bulk-airtime.show', $transaction->batchUpload->id) }}" 
...
<script>
    ...
    function showToken(token, transactionId) {
        ...
        if (downloadBtn && transactionId) {
            downloadBtn.href = `/bulk-airtime/transaction/${transactionId}/download`;
    ...
    function downloadToken(transactionId) {
        ...
        window.location.href = `/bulk-airtime/transaction/${transactionId}/download`;
    }
    ...
    document.addEventListener('DOMContentLoaded', function() {
        document.querySelectorAll('.transaction-row').forEach(row => {
            row.addEventListener('click', function(e) {
                ...
                const viewLink = this.querySelector('a[href*="/bulk-airtime/transaction/"]');
                if (viewLink) {
