...
@section('title', 'Batch Details - ' . $batch->batch_name . ' - WinIt Prize Distribution')
                                ...
                                <tbody>
                                    @foreach($batch->recipients as $recipient)
                                        <tr>
                                            ...
                                            <td>
                                                <span class="disco-badge">{{ $recipient->disco }}</span>
                                            </td>
                                            <td>
                                                <div class="recipient-meter">{{ $recipient->meter_number }}</div>
                                            </td>
                                            <td>
                                                <span class="meter-type-badge {{ $recipient->meter_type }}">
                                            ...
                                            <td>
                                                <div class="address-text" title="{{ $recipient->address }}">
                                                    {{ $recipient->address }}
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                @if($recipient->transaction && $recipient->transaction->units)
                                                    <div class="units-text">{{ $recipient->transaction->units }} KWh</div>
                                                @else
                                                    <span class="text-muted">—</span>
                                                @endif
                                            </td>
...
function refreshStatus() {
    utils.makeRequest(`/bulk-token/status/{{ $batch->id }}`)
        .then(data => {
            if (data.success) {
                // Update progress bar
