...
@section('title', 'Bulk DSTV Dashboard')
    ...
    <div class="d-flex align-items-start">
        ...
        <div class="ms-3 flex-grow-1">
            <h5 class="alert-heading mb-2" style="color: #059669; font-weight: 700;">
                <i class="fas fa-mobile-alt me-2"></i>BuyPower TV DSTV Integration
            </h5>
            <p class="mb-2" style="color: #065f46;">
                The system uses the optimized <strong>/vend</strong> endpoint for TV (DSTV) subscription distribution. Process multiple DSTV subscriptions efficiently in batches.
            </p>
            <div class="row mt-3">
                <div class="col-md-6">
                    <div class="d-flex align-items-center mb-2">
                        <i class="fas fa-check-circle me-2" style="color: #10b981;"></i>
                        <span><strong>Response Time:</strong> ~2-3 seconds per transaction</span>
                    </div>
                    <div class="d-flex align-items-center mb-2">
                        <i class="fas fa-check-circle me-2" style="color: #10b981;"></i>
                        <span><strong>Amount Range:</strong> ₦100 - ₦100,000 per subscription</span>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="d-flex align-items-center mb-2">
                        <i class="fas fa-check-circle me-2" style="color: #10b981;"></i>
                        <span><strong>Format:</strong> CSV (name, phone_number, meter, amount)</span>
                    </div>
                    <div class="d-flex align-items-center mb-2">
                        <i class="fas fa-info-circle me-2" style="color: #0891b2;"></i>
                        <span><strong>Sample CSV:</strong> Download template below</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card-body">
            ...
            <div class="alert alert-info mb-4">
                    ...
                    <ul class="mb-2">
                        ...
                        <li><strong>meter</strong> - DSTV smartcard number (10-11 digits, e.g., 1056356039)</li>
                        <li><strong>disco</strong> - Must be "DSTV" (case-insensitive)</li>
                        <li><strong>amount</strong> - DSTV subscription amount in Naira (₦100 - ₦100,000, e.g., 17150.00)</li>
                        <li><strong>email</strong> - <em>Optional:</em> Recipient's email address</li>
                    ...
                    <div class="alert alert-success mt-3" style="background: linear-gradient(135deg, rgba(16, 185, 129, 0.1) 0%, rgba(16, 185, 129, 0.05) 100%); border: 1px solid #10b981;">
                        <h6><i class="fas fa-check-circle me-2" style="color: #10b981;"></i>DSTV Subscription Information:</h6>
                        <div class="row">
                            <div class="col-md-6">
                                <ul class="mb-0">
                                    <li><strong>Phone Number:</strong> Must be 10-11 digits ✅</li>
                                    <li><strong>Smartcard Number:</strong> 10-11 digits (e.g., 1056356039) ✅</li>
                                    <li><strong>Disco:</strong> Must be "DSTV" ✅</li>
                                    <li><strong>Amount Range:</strong> ₦100 - ₦100,000 ✅</li>
                                </ul>
                            </div>
                            <div class="col-md-6">
                                <ul class="mb-0">
                                    <li><strong>Processing:</strong> Instant delivery ✅</li>
                                    <li><strong>Response Time:</strong> ~2-3 seconds ✅</li>
                                    <li><strong>Status:</strong> Real-time updates ✅</li>
                                    <li><strong>Vertical:</strong> TV ✅</li>
                                </ul>
                            </div>
                        </div>
                        <small class="text-muted d-block mt-2">
                            <i class="fas fa-lightbulb me-1"></i>The CSV format requires name, phone_number, meter (DSTV smartcard number), disco (must be "DSTV"), and amount. DSTV subscriptions are delivered instantly to the specified smartcard number.
                        </small>
                    </div>
                    <div class="alert alert-warning mt-3">
                        <h6><i class="fas fa-exclamation-triangle me-2"></i>Important Notes:</h6>
                        <ul class="mb-0">
                            <li><strong>Phone Number:</strong> Must be 10-11 digits starting with 080, 081, 070, 090, or 091</li>
                            <li><strong>Meter Field:</strong> DSTV smartcard number (10-11 digits, e.g., 1056356039) - NOT a phone number</li>
                            <li><strong>Disco:</strong> Must be exactly "DSTV" (case-insensitive, but will be converted to uppercase)</li>
                            <li><strong>Amount:</strong> Minimum ₦100, maximum ₦100,000 per DSTV subscription</li>
                            <li><strong>Processing:</strong> DSTV subscriptions are delivered instantly to the smartcard number</li>
                            <li><strong>API Endpoint:</strong> Uses vertical "TV" and disco "DSTV" as per BuyPower API specification</li>
                        </ul>
                    </div>
                    <div class="mt-3">
                        <a href="{{ route('bulk-dstv.download-sample') }}" 
                           class="btn btn-outline-primary btn-sm" 
                           download="sample_recipients.csv"
                           data-bs-toggle="tooltip" 
                           data-bs-placement="top" 
                           title="Download sample CSV for DSTV subscriptions. Format: name, phone_number, meter (smartcard), disco (DSTV), amount">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center p-3" style="background: linear-gradient(135deg, rgba(59, 130, 246, 0.05) 0%, rgba(59, 130, 246, 0.02) 100%); border-radius: 0.75rem; border: 2px solid rgba(59, 130, 246, 0.2);">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <small class="text-muted">Send DSTV subscription notification via SMS</small>
                                                </div>
                                            </div>
                                        ...
                                        <div class="d-flex justify-content-between align-items-center p-3" style="background: linear-gradient(135deg, rgba(16, 185, 129, 0.05) 0%, rgba(16, 185, 129, 0.02) 100%); border-radius: 0.75rem; border: 2px solid rgba(16, 185, 129, 0.2);">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <small class="text-muted">Send DSTV subscription notification via Email</small>
                                                </div>
                                            </div>
                                            <div class="form-check form-switch">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <div class="d-flex flex-wrap gap-2 mb-3">
                                        ...
                                        <span class="badge bg-info" style="cursor: pointer;" onclick="insertVariable('sms_template', '{phone_number}')">{phone_number}</span>
                                ...
                                <textarea 
                                    ...
                                    class="form-control" 
                                    rows="5" 
                                    placeholder="Your DSTV top-up from WinIt is complete!
Amount: ₦{amount}
Phone: {phone_number}
Date: {date} {time}
Thank you for using WinIt!">
Your DSTV top-up from WinIt is complete!
Amount: ₦{amount}
Phone: {phone_number}
Date: {date} {time}
Thank you for using WinIt!</textarea>
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <div class="d-flex flex-wrap gap-2 mb-3">
                                        ...
                                        <span class="badge bg-success" style="cursor: pointer;" onclick="insertVariable('email_template', '{phone_number}')">{phone_number}</span>
...
Thank you for using WinIt!</textarea>
            ...
            <!-- Processing Status -->
                <div id="processingStatus" class="mt-4 d-none">
                    ...
                    <div class="card-body">
                        <h6><i class="fas fa-cog fa-spin"></i> Processing DSTV Batch...</h6>
                        <small class="text-muted d-block mt-1">
                            <i class="fas fa-info-circle"></i> Processing DSTV subscriptions in batches (each batch completes before next starts)
                        </small>
                            <div class="row">
                                <div class="col-md-6">
...
<script>
        ...
        if (passwordForm) {
            passwordForm.addEventListener('submit', async function(e) {
                ...
                try {
                    ...
                    const verifyUrl = '{{ route("bulk-dstv.verify-password") }}';
    ...
    function handleUpload(e) {
        ...
        console.log('Upload URL:', '{{ route("bulk-dstv.upload") }}');
        
        fetch('{{ route("bulk-dstv.upload") }}', {
            method: 'POST',
            body: formData,
            headers: {
                'X-CSRF-TOKEN': csrfToken,
        ...
        .then(({ data, response }) => {
            ...
            if (data.success) {
                ...
                successMessage += `<br>Click "Start DSTV Distribution" to proceed.`;
        ...
        .catch(error => {
            ...
            errorMessage += '<br><small>💡 Make sure your CSV file has the required columns: name, phone_number, meter, disco, amount</small>';
    ...
    function startProcessing(batchId = null) {
        ...
        console.log('Process URL:', `/bulk-dstv/process/${batch}`);
        
        fetch(`/bulk-dstv/process/${batch}`, {
            method: 'POST',
            headers: {
                'X-CSRF-TOKEN': csrfToken,
                'X-Requested-With': 'XMLHttpRequest',
        ...
        .then(data => {
            ...
            if (data.success) {
                ...
                // Show detailed success message
                let successMessage = `🚀 <strong>DSTV Distribution Started!</strong><br>`;
    ...
    function pollProcessingStatus() {
        ...
        const poll = () => {
            fetch(`/bulk-dstv/status/${batchId}`, {
                headers: {
                    'X-Requested-With': 'XMLHttpRequest',
                    'Accept': 'application/json'
                }
    ...
    function showCompletionMessage(data) {
        ...
        if (data.status === 'completed') {
            ...
            message += `<strong>${data.successful_transactions}/${data.total_recipients}</strong> DSTV subscriptions sent successfully (${successRate}% success rate)<br>`;
            ...
            message += `${data.successful_transactions || 0}/${data.total_recipients} DSTV subscriptions processed`;
            ...
            <div class="alert alert-info batch-processing-options">
                ...
                <div class="d-flex gap-2">
                    <button type="button" class="btn btn-success btn-sm" onclick="startProcessing(${batchId})">
                        <i class="fas fa-play"></i> Start DSTV Distribution
                    </button>
                    <button type="button" class="btn btn-outline-secondary btn-sm" onclick="window.location.href='{{ route("bulk-dstv.history") }}'">
