...
@section('title', 'DSTV Batch Details - ' . $batch->batch_name . ' - WinIt Prize Distribution')
    ...
    <div class="batch-details-card">
        <div class="batch-header">
            ...
            <div class="d-flex gap-2">
                <a href="{{ route('bulk-dstv.history') }}" class="btn btn-outline-secondary">
...
function refreshStatus() {
    utils.makeRequest(`/bulk-dstv/status/{{ $batch->id }}`)
        .then(data => {
            if (data.success) {
                // Update progress bar
